...
## [0.1.1] - 2025-11-19
### Fixed
- Fixed an issue with how options are compiled in the `authenticate()` method.
...
[Unreleased]: https://github.com/supernovus/passport-totp/compare/v.1.1...HEAD
[0.1.1]: https://github.com/supernovus/passport-totp/compare/v.1.0...v0.1.1
